...
import auth from '../Assets/industry-2630319.jpg'
import {
  MDBContainer,
  MDBNavbar,
  MDBNavbarBrand
  ...
  return (
    <div>
        ...
        <MDBNavbarBrand href='#'>
           ...
           {/* <istyle={{color:'white'}} class="fa-solid fa-laptop-file fa-fade ex-3 fs-2 m-2"></i> */}
            <h2>Project Fair</h2> 
          </MDBNavbarBrand>
        </MDBContainer>
      </MDBNavbar>
    <div className='d-flex flex-column justify-content-center align-items-center' style={{ width: '100%', height: '850px' }}>
      ...
      <div className='container '>
        <div className="row">
          <div className="col">
            {/* image*/}
            <img src={auth} width={'100%'} height={'100%'} alt="" />
          </div>
            ...
            <form>
              {
                ...
                <input type="text" value={userData.github} onChange={e=>setUserData({...userData, github: e.target.value})} className='form-control mb-3' placeholder='Enter Github' />
    
                <input type="text" value={userData.link} onChange={e=>setUserData({...userData, link: e.target.value})} className='form-control mb-3' placeholder='Enter link' />
