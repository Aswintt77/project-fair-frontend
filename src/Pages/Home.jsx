...
import TitleImage from '../Assets/student-849826.jpg'
        ...
        <div className="row">
          <div className="col-6 ">
            ...
            <div className='text-center'>
              <Link to={'/login'}>
                <button className='btn btn-outline-primary m-3 shadow '>Get Started</button>
              </Link>
            </div>
          </div>
          <div className="col-6">
            <img src={TitleImage} alt="" height={'320px'} style={{ margin: '5px',borderRadius:'10px' }} />
          </div>
        </div>
        <div className="row">
          <div className="col">
